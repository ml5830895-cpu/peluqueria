...
<body>
	...
	<form method="POST" action="actualizar_clave_user.php" class="formulario" id="formulario">
  <p style="padding: 0px;"></p>

<!-- Grupo: Contraseña -->
<div class="formulario__grupo" id="grupo__password">
		<label for="password" class="formulario__label">Nueva Contraseña</label>
			<input type="password" class="formulario__input" name="password" id="password" placeholder="********"  required>
      <p style="padding: 0px;"></p>
	<!-- Grupo: Confirmar contraseña -->
		<label for="password2" class="formulario__label">Repetir Nueva Contraseña</label>
			<input type="password" class="formulario__input" name="password2" id="password2" placeholder="********"  required>
