  ...
  <div class="table-container">
    ...
    <table class="user-table">
      <tr>
        ...
        <td class="text-center"><button class="btn btn-primary" onclick="window.location.href = 'editar_correo_user.php';">Editar</button></td>
      </tr>
      <tr>
        <td><b>Contraseña:</b></td>
        <td>********</td>
        <td class="text-center"><button class="btn   btn-primary" onclick="window.location.href = 'editar_clave_user.php';">Editar</button></td>
      </tr>
    </table>
  </div>
</div>
