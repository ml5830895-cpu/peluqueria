...
<body>
    ...
    <h3 class="text-center py-3"><b>AGENTA TU CITA</b></h3>


    <!-- Grupo: Nombre -->

    <div class="btn-container">
    <h3 class="text-center py-3"><b>Formulario para registrar nueva cita</b></h3>

	<form method="POST" action="registrar_cita.php" class="formulario" id="formulario">
  ...
  try {
      // Consulta para obtener los servicios de la tabla_servicio
      $sql = "SELECT id_servicio, nombre_servicio FROM tabla_servicio WHERE 1";
...
<br><br><br>
	...
	<!-- Grupo: Confirmar contraseña -->
		<label for="password2" class="formulario__label">Seleciona para que dia la quieres:</label>
			<input type="date" class="formulario__input" name="password2" id="password2" placeholder="********"  required>
