...
<body>
    <div class="head">
        <nav class="navbar">
            ...
            <p>Bienvenido Querido usuario  <?php echo $username; ?></p>
        </nav>
    </div>
    <br><br><br><br><br><br><br>
    <img src="usuer.png" alt="Descripción de la imagen" width="200">
    ...
    <H1>USUARIO</H1>
        ...
        if (isset($_SESSION["loggedIn"]) && $_SESSION["loggedIn"] === true) {
            echo "<div class='btn-container'>
                        ...
                        <a href='consultar_citas_user.php' class='btn'>Consultar citas</a>
                        <a href='agendar_cita.php' class='btn'>Agendar cita</a>

                        <a href='editar_datos_user.php' class='btn'>Editar datos</a>
